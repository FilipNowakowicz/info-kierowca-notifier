...
(() => {
  ...
  const PL = {
    ...
    'Before continuing, have the date of your existing booked exam ready. It is required because alerts are sent only for earlier slots.': 'Przed kontynuowaniem przygotuj datę obecnie zarezerwowanego egzaminu. Jest wymagana, ponieważ aplikacja powiadamia tylko o wcześniejszych terminach.',
